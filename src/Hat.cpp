...
std::unique_ptr<ppgso::Shader> Hat::shadow_shader;
...
bool Hat::update(float dt, SceneWindow &scene) {
    updateModelMatrix();
...
void Hat::render(SceneWindow &scene) {
    shader->use();
...
void Hat::render_shadow(SceneWindow &scene, glm::mat4 lightSpaceMatrix) {
